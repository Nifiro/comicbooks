package com.comicbooks.application;
...
public class ComicbooksApp {
    ...
    public ComicbooksApp(Environment env) {
        this.env = env;
    }

    /**
     * Initializes comicbooks.
     * <p>
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(ComicbooksApp.class);
