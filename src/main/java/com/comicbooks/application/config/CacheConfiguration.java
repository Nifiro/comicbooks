package com.comicbooks.application.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            cm.createCache(com.comicbooks.application.repository.UserRepository.USERS_BY_LOGIN_CACHE, jcacheConfiguration);
            cm.createCache(com.comicbooks.application.repository.UserRepository.USERS_BY_EMAIL_CACHE, jcacheConfiguration);
